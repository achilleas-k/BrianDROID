...
int32_t __attribute__((kernel)) updateall(int32_t idx) {
    const int _neuron_idx = idx;
    float I = array_gp_I[_neuron_idx];
...
int32_t __attribute__((kernel)) hupdate(int32_t idx) {
    const int _neuron_idx = idx;
    float I = array_gp_I[_neuron_idx];
    float h = array_gp_h[_neuron_idx];
    float m = array_gp_m[_neuron_idx];
...
int32_t __attribute__((kernel)) mupdate(int32_t idx) {
    const int _neuron_idx = idx;
    float I = array_gp_I[_neuron_idx];
    float h = array_gp_h[_neuron_idx];
    float m = array_gp_m[_neuron_idx];
...
int32_t __attribute__((kernel)) vupdate(int32_t idx) {
    const int _neuron_idx = idx;
    float I = array_gp_I[_neuron_idx];
    float h = array_gp_h[_neuron_idx];
    float m = array_gp_m[_neuron_idx];
...
int32_t __attribute__((kernel)) nupdate(int32_t idx) {
    const int _neuron_idx = idx;
    float I = array_gp_I[_neuron_idx];
    float h = array_gp_h[_neuron_idx];
    float m = array_gp_m[_neuron_idx];
