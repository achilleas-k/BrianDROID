 ...
 *
 * Java implementation of the standalone COBAshort simulation.
 *
...
public class COBAshort {
    ...
    private final String DESCRIPTION = "\n"
        +"Much smaller version of the COBAshort simulation for quick testing\n\n"
        +"N = 4000\n"
        +"duration = 1 second\n"
        +"\n"
        +"Model equations:\n"
