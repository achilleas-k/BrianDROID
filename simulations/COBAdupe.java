 ...
 *
 * Java implementation of the standalone COBAdupe simulation.
 *
...
public class COBAdupe {
    ...
    private final String DESCRIPTION = "\n"
       +"Duplicate of the COBA class for testing"
       +"\n\n\n\n"
       +"N = 4000\n"
       +"duration = 1 second\n"
       +"\n"
    ...
    public void run() {
        ...
        //    //    dir.mkdirs();
        //    //    String spikesFilename = "briandroidCOBAdupe.spikes";
